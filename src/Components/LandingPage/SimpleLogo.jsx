...
const SimpleLogo = () => {
    ...
    return (
        <div>
            ...
            >
                <path fill="none" d="M298 2163 c1 -164 7 -342 13 -395 42 -394 249 -607 634 -654 193 -24
...
-70 135 6 19 15 20 126 20 l120 0 -3 280 -3 280 -435 0 -435 0 3 -297z"
                />
                <path fill="none" d="M1303 2318 c4 -79 7 -203 7 -275 l0 -133 415 0 415 0 32 -29 c28 -25
...
-138 312 -271 375 -160 75 -320 94 -809 95 l-369 0 6 -142z"
                />
                <path className="svgAirEng" fill="none" d="M350 170 l0 -110 25 0 26 0 -3 107 c-3 101 -4 106 -25 109 -23 4 -23
2 -23 -106z" />
                <path className="svgAirEng" fill="none" d="M420 168 c0 -107 0 -108 24 -108 24 0 24 1 18 85 l-5 86 84 -3 c78
...
-26 22 -130 25 l-115 3 0 -107z" />
                <path className="svgAirEng" fill="none" d="M900 168 l0 -108 110 0 110 0 0 25 c0 25 -1 25 -85 25 -76 0 -85 2
...
19 5 20 85 17 85 -3 85 -3 85 22 l0 25 -110 0 -110 0 0 -107z" />
                <path className="svgAirEng" fill="none" d="M1140 169 l0 -109 25 0 c24 0 25 2 25 76 l0 75 63 -75 c43 -53 69
-76 85 -76 21 0 22 3 22 110 l0 110 -26 0 -26 0 7 -77 c4 -51 3 -75 -3 -68 -5
6 -35 39 -65 74 -38 43 -64 65 -81 67 l-26 3 0 -110z" />
                <path className="svgAirEng" fill="none" d="M1515 272 c-115 -4 -125 -11 -125 -102 0 -93 13 -104 134 -108 l93
...
1 6 38 10 91 10 82 0 90 2 90 19 0 26 -1 26 -105 23z" />
                <path className="svgAirEng" fill="none" d="M1639 270 c0 -3 -1 -50 -1 -105 1 -93 2 -100 21 -103 20 -3 21 1 21
105 0 102 -1 109 -20 109 -11 0 -20 -3 -21 -6z" />
                <path className="svgAirEng" fill="none" d="M1710 273 c-1 -2 -1 -49 -1 -105 -1 -100 0 -103 22 -103 21 0 22 3
...
-31 37 -64 75 -40 47 -68 71 -82 71 -11 0 -21 -2 -21 -3z" />
                <path className="svgAirEng" fill="none" d="M1950 168 l0 -108 110 0 110 0 0 25 c0 25 -1 25 -91 25 -81 0 -90 2
...
14 16 17 88 18 80 2 85 3 85 24 0 21 -4 22 -108 23 l-107 2 0 -107z" />
                <path className="svgAirEng" fill="none" d="M2190 168 l0 -108 110 0 110 0 0 25 c0 25 -1 25 -85 25 -76 0 -85 2
...
18 7 20 85 20 81 0 85 1 85 23 0 21 -3 22 -110 22 l-110 0 0 -107z" />
                <path className="svgAirEng" fill="none" d="M2430 168 l0 -108 25 0 c25 0 25 1 25 85 l0 85 79 0 c54 0 80 -4 83
...
l-120 5 0 -107z" />
                <path className="svgAirEng" fill="none" d="M2835 271 c-96 -6 -100 -7 -113 -33 -15 -32 -3 -72 29 -89 14 -7 48
...
4 21 95 17 l95 -3 0 28 c0 15 -3 26 -7 25 -5 -1 -53 -4 -108 -7z" />
                <path className="svgAirEng" fill="none" d="M86 248 c-11 -16 -16 -46 -16 -105 0 -82 0 -83 25 -83 25 0 25 1 25
